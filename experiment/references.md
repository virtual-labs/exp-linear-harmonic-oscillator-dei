...
1. Griffiths, D. J., & Schroeter, D. F. (2018). *Introduction to Quantum Mechanics* (3rd ed.). Cambridge University Press.  
   (Chapter 2: Operator method, ground state \( \psi_0(x) \), expectation values)

2. Shankar, R. (2012). *Principles of Quantum Mechanics* (2nd ed.). Springer.  
   (Chapter 6: Matrix mechanics, coherent states)

3. Messiah, A. (1999). *Quantum Mechanics* (Vol. 1, Dover ed.). Dover Publications.  
   (Chapter V: Analytic series solution and recursion relations)

4. Sakurai, J. J., & Napolitano, J. J. (2020). *Modern Quantum Mechanics* (3rd ed.). Cambridge University Press.  
   (Chapter 2: Heisenberg picture application)

5. OpenStax. (2016). *University Physics Volume 3*. OpenStax.  
   https://openstax.org/details/books/university-physics-volume-3  
   (Section 7.6: Introductory treatment of zero-point energy)
...
1. Wikipedia contributors. (2026). *Quantum harmonic oscillator*.  
   ...
   (Ladder operators and 3D isotropic case)

2. Physics LibreTexts. (2025). *7.6: The Quantum Harmonic Oscillator*.  
   https://phys.libretexts.org/Bookshelves/University_Physics/.../7.6:_The_Quantum_Harmonic_Oscillator  
...
3. Zwiebach, B. (2013). *Quantum Physics I (MIT OpenCourseWare 8.04), Lecture 8: Quantum Harmonic Oscillator*.  
   ...
   (PDF and video lectures on time evolution)

4. Schroeder, D. V. (Ongoing). *Quantum Harmonic Oscillator Simulation*. Weber State University.  
   https://physics.weber.edu/schroeder/software/HarmonicOscillator.html  
   (Interactive wavefunction superposition simulation)
